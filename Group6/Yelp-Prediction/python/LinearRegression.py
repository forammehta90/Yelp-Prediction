...
class LinearRegression(object):
    ...
    def loadFiles(self):
        ...
        dataset = list()
        dataset_test = list()
        file = '/Users/forammehta/Desktop/foram/sjsu/255/Project/Yelp-Prediction/files/business_multi_le_finally_train_full.csv'
    ...
    def DR(self,mat_train,mat_test):
        ...
        return self.lf_classify(X_chi2,X_chi2_test)

    def lf_classify(self,X_chi2,X_chi2_test):
        from sklearn.metrics import f1_score
        from sklearn import linear_model
        from sklearn.metrics import mean_squared_error, r2_score

        regr = linear_model.LinearRegression()
        regr.fit(X_chi2, self.labels)
        y_predict = regr.predict(X_chi2_test)
